...
//       cpuCountStr=@"single";
   ...
   NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    ...
    [request setURL:[NSURL URLWithString:@"http://amada.magnavision360.com/waiting_webservice.php"]]; //Prod Web Service
...
-(void)performExitAction
{
    ...
    [request setURL:[NSURL URLWithString:@"http://amada.magnavision360.com/exit_webservice.php"]];    //Prod Webservice
