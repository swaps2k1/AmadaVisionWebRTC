...
-(void)updateThatIAmConnected:(NSTimer *)timer
{
    ...
    [request setURL:[NSURL URLWithString:@"http://amada.magnavision360.com/checkActive_webservice.php"]];     //Production webservice
...
-(void)performExitAction
{
    ...
    [request setURL:[NSURL URLWithString:@"http://amada.magnavision360.com/exit_webservice.php"]];    //Production Webservice
